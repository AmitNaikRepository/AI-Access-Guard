...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Aspire.AI - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Aspire.AI - React.js Tailwind CSS Admin Dashboard Template"
      />
